...
const MedicalStoreTabNavigator = () => {
  return (
    <Tab.Navigator
      screenOptions={({ route }) => ({
    ...
    >
      <Tab.Screen name="Home" component={MedicalStoreDashboard} />
      <Tab.Screen name="New Order" component={UserProductList} />
      <Tab.Screen 
        name="My Orders" 
        component={OrderList} 
        initialParams={{ role: 'medical_store' }} 
      />
...
export default MedicalStoreTabNavigator;
